...
-   Go supports the
    [Go tool](https://github.com/proxy-wasm/proxy-wasm-rust-sdk/tree/main/examples/helloworld)
...
*   Add a repo rule for the Go repo using gazelle: `$ bazel run //:gazelle --
    update-repos $MY_REPO`
*   Add a import statement to the Go source file
