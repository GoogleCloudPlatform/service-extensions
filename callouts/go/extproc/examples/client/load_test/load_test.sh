...
# Request data for testing client example
# This simulates both request and response scenarios
REQUEST_DATA='[
  {
    "request_headers": {
      "headers": {
        "headers": [
          {"key": "client-request-header", "raw_value": "cmVxdWVzdC12YWx1ZQ=="}
        ]
      },
      "end_of_stream": false
    }
  ...
  {
    "request_body": {
      "body": "Y2xpZW50LXJlcXVlc3QtYm9keQ==",
      "end_of_stream": true
    }
  },
  {
    "response_headers": {
      "headers": {
        "headers": [
          {"key": "client-response-header", "raw_value": "cmVzcG9uc2UtdmFsdWU="}
        ]
      },
      "end_of_stream": false
    }
  ...
  {
    "response_body": {
      "body": "Y2xpZW50LXJlc3BvbnNlLWJvZHk=",
      "end_of_stream": true
    }
  }
]'
...
# Calculate absolute path to protos
