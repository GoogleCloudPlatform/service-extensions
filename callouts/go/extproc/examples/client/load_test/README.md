# Load Testing for Client Callout

This directory contains load testing tools for the external processor client service. It encapsulates various testing scenarios to measure the performance and functionality of the service.
